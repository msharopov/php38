...
<div class="container py-4">
    <header class="pb-3 mb-4 border-bottom">
        <a href="/" class="d-flex align-items-center text-body-emphasis text-decoration-none">
            ...
            <span class="fs-4">Postni o'zgatirish</span>
        </a>
    </header>
    ...
    <div class="p-5 mb-4 bg-body-tertiary rounded-3">
        <form method="POST" action="" class="container-fluid py-5">
            ...
            <div class="mb-3">
                <label class="form-label">Maxsulot nomi</label>
                <input name="nomi" type="text"  class="form-control"value="<?= $prices['nomi']?>" >
            </div>
            <div class="mb-3">
                <label class="form-label">Maxsulot xaqida</label>
                <textarea name="xaqida" class="form-control" rows="3"><?= $prices['xaqida']?> </textarea>
            </div>
            <div class="mb-3">
                <label class="form-label">Ishlab chiqarilgan joyi</label>
                <input name="made_in" type="text" class="form-control" value="<?= $prices['made_in']?>" >
            </div>
            <div class="mb-3">
                <label class="form-label">Ishlab chiqarilgan vaqti</label>
                <input name="made_at" type="date" class="form-control" value="<?= $prices['made_at']?>" >
            </div>
